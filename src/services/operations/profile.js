...
export function loadUserAdditionalDetailsFromBackend(navigate , token , userCurrentData){
    ...
    return async (dispatch) => {
        ...
        try {
            const responseFromapiConnector = await requestBackend('GET' , profileAllRoutes.get_All_User_Details , {token} , {Authorization : `Bearer ${token}`} ,);
